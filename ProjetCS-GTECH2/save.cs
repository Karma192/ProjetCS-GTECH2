...
namespace GameSave
{
    internal class Save
    {
        ...
        public void DoSave(Player player, Team team, MapManager mapManager, Inventory inventory)
        {
            ...
            string fileName = @"..\..\..\..\ProjetCS-GTECH2\save\save_fighter.json";
            string jsonString = JsonSerializer.Serialize(team.Fighters, option);
            File.WriteAllText(fileName, jsonString);

            string fileName1 = @"..\..\..\..\ProjetCS-GTECH2\save\save_inventory.json";
